...
//        audioManager = (AudioManager) getSystemService(ColorsActivity.AUDIO_SERVICE);
//
...
//
//        //set Adapter to show
//        WordAdapter showColor = new WordAdapter(this, words, R.color.category_colors);
//
...
//        super.onStop();
//        //when it all stop need to release resource out of memory
//        releaseMedia();
//    }
}
