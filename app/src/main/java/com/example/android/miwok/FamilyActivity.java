...
//        audioManager = (AudioManager) getSystemService(FamilyActivity.AUDIO_SERVICE);
//
//        /**
...
//        WordAdapter showFamily = new WordAdapter(this, familyWords, R.color.category_family);
//
//        // find listView in family Layouts
//        ListView listFamily = (ListView) findViewById(R.id.list);
//
